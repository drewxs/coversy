...
const testingUser = {
    user: {
        ...
        verified: true,
        confirmationCode:
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRvbW5ndXllbjI2MDRAZ21haWwuY29tIiwiaWF0IjoxNjQ0OTk3Mzc2fQ.-O9vsfwEMA9W2EewOHb1oIT_-XJkHRPeA3fZU3baDiU',
        site: {
            address: {
                street: '123 Main St',
                zip: 'A1A1A1',
