...
export const AdminShifts = () => {
  ...
  return (
    <>
          ...
          {loading ? (
            ...
            <>
              ...
              {shifts?.length > 0 ? (
                  ...
                  <TableBody>
                    {shifts?.map((shift) => (
                      <TableRow key={shift._id}>
                        ...
                        <TableCell>
                          {moment(shift.startTime).format('MMM D, Y')}
                        </TableCell>
                        <TableCell>
                ...
                <p>No shifts currently exist, please upload a schedule.</p>
              )}
            </>
          )}
        </div>
      ...
      <Modal open={openShiftUpload} onClose={() => SetOpenShiftUpload(false)}>
        ...
        <Box className='modal-container' sx={{ width: 400 }}>
          ...
          <Box sx={{ '& .MuiTextField-root': { mb: '1rem' } }}>
            <form onSubmit={handleSave}>
              ...
              />
              <InputLabel sx={{ mt: '1rem' }}>End Time</InputLabel>
              <DateTimePicker
                monthPlaceholder='mm'
                dayPlaceholder='dd'
                yearPlaceholder='yyyy'
